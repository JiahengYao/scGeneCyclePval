...
expression_matrix = pd.read_csv('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_shuffle_4/input_data.csv', index_col=0)
...
pseudotime_file = os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_shuffle_4', 'pseudotime.h5')
...
weights_file = os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_shuffle_4', 'weights.h5')
...
# plt.savefig(os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_shuffle_4', 'pseudotime_plot.png'))
# plt.close()
