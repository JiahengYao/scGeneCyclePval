...
expression_matrix = pd.read_csv('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_original/input_data.csv', index_col=0)
...
pseudotime_file = os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_original', 'pseudotime.h5')
...
weights_file = os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_original', 'weights.h5')
...
# plt.savefig(os.path.join('../data/cache/sample_GSM6886537_Sigmoid_03T_CellType_IgA__Plasma_cells/The_compare_original', 'pseudotime_plot.png'))
# plt.close()
